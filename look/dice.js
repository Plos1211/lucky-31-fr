...
function denyWager(message){verdictView.textContent=message;wagerInput.classList.remove('rl-deny-106db3cb');void wagerInput.offsetWidth;wagerInput.classList.add('rl-deny-106db3cb');}
...
function clearFlash(){dieView.classList.remove('rl-win-106db3cb');dieView.classList.remove('rl-lose-106db3cb');if(frameEl){frameEl.classList.remove('rl-win-106db3cb');frameEl.classList.remove('rl-lose-106db3cb');}}
function flashOutcome(won){clearFlash();if(won){dieView.classList.add('rl-win-106db3cb');if(frameEl){frameEl.classList.add('rl-win-106db3cb');}}else{dieView.classList.add('rl-lose-106db3cb');if(frameEl){frameEl.classList.add('rl-lose-106db3cb');}}
...
var brandEl=document.querySelector('.rl-brand-106db3cb');var echoEl=grab('rl-echo');if(brandEl&&echoEl){echoEl.textContent=brandEl.textContent.replace(/\s+/g,' ').trim();}
